...
<!-- Format query results for display --><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:i18n="http://apache.org/cocoon/i18n/2.1" version="1.0">
    ...
    -->
    <xsl:variable name="filename" select="'https://www.udir.no/contentassets/a7d84e333b6c4391b3e212c1b9af6ef9/somali-udir_forelderinfo_skole_bokmaal.pdf'"/>
    <xsl:variable name="text_encoding" select="''"/>
    <xsl:variable name="title" select="'Warbixin ku socota waalidka iskoollada'"/>
    <!--
